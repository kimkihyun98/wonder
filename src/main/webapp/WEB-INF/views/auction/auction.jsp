	...
	<div class="grid">
		<div class="grid-item">
			...
			<div class="wrapgriditem">
				...
				<img class="author-thumb" src="resources/img/gravatar.jpg" alt="David" nopin="nopin"/>
				David
				<time class="post-date" datetime="2015-12-17">17 December 2016</time>
				</footer>
			</div>
			</article>
		</div>
		...
		<div class="grid-item">
			<article class="post tag-romance">
			<a href="article.html"><img src="http://s3.amazonaws.com/caymandemo/wp-content/uploads/sites/10/2015/09/10175658/j5-520x780-520x600.jpg"></a>
			<div class="wrapgriditem">
				<header class="post-header">
