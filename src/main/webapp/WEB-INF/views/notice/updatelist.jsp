	...
	<div data-v-76574781="">
			...
			<nav data-v-7bcac446="" data-v-76574781="" class="snb">
				...
				<!---->
					<ul data-v-4d11470e="" data-v-7bcac446="" class="snb_menu">
						...
						<li data-v-4d11470e="" class="menu_item menu_on"><a data-v-4d11470e="" href="${contextPath}/notice/update" class="menu_link"> 업데이트 </a></li>
		...
		<div data-v-76574781="" class="content_area">
			<div data-v-0067a928="" data-v-76574781="" class="customer_content my_notice">
				<div data-v-88eb18f6="" data-v-0067a928="" class="content_title border">
					...
					<h3 data-v-88eb18f6="">업데이트</h3>
					<br>
					</div>
					</div>
			<c:forEach var="Notice" items="${list}">	
			   <c:if test="${Notice.notice_sort eq '업데이트'}">
		...
		<ul class="pagination">
				<c:if test="${pageMaker.prev}">
					<li class="list"><a href="update?page=${pageMaker.startPage-1}">&laquo;</a></li>
				</c:if>
				<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
				 	<li class="list">
				 		<a 
				 		<c:out value="${pageMaker.cri.page == idx?'style=color:blue':''}"/>
				 		href="update?page=${idx}">${idx}</a>
				    </li> 			
				</c:forEach>
				
				<c:if test ="${pageMaker.next && pageMaker.endPage >0 }">
					<li class="list"><a href ="update?page=${pageMaker.endPage+1 }">&raquo;</a></li>
	   			</c:if>
